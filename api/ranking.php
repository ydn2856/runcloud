...
?>	
	<img src="img/nutc_logo2.png" height="250px" width="250px">
<?php	
}
else if($rs[3]=='朝陽科大'){
?>	
	<img src="img/nutc_logo3.png" height="250px" width="250px">
<?php
}
else if ($rs[3]=='逢甲大學'){			  
?>
    <img src="img/nutc_logo4.gif" height="250px" width="250px">                    
<?php
}
?>						 
                    ...
                    <div class="mbr-plan-body card-block">
                      <div class="mbr-plan-list"><ul class="list-group list-group-flush"><li class="list-group-item"><font size="7"><?php echo $rs[2]?>分</font></li></ul></div>
